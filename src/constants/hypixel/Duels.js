export const DUELS = {
	...
	DIVISIONS: [
		...
		{name: 'Diamond',     id: 'diamond',     color: 'darkaqua',  style: '§3' },
		...
		{name: 'DIVINE',      id: 'divine',      color: 'pink',      style: '§d§l' },
	...
	MODES: [
		...
		{id: 'bowspleef_duel', divisionId: 'spleef', name: 'Bow Spleef 1v1'},
		{id: 'spleef_duel', divisionId: 'spleef', name: 'Spleef 1v1'},
